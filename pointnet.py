...
class PointNetEncoder(nn.Module):
    def __init__(self, global_feat=True, input_transform=True, feature_transform=False, semseg=False):
...
class PointNetCls(nn.Module):
    def __init__(self, k=2):
        ...
        self.feat = PointNetEncoder(global_feat=True, input_transform=True, feature_transform=True)
        self.fc1 = nn.Linear(1024, 512)
        self.fc2 = nn.Linear(512, 256)
